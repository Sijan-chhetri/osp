...
const CartridgeCategoryEdit: FC = () => {
  ...
  const fetchCategory = async () => {
    try {
      ...
      const response = await fetch(API_ENDPOINTS.CARTRIDGE_CATEGORY(id!), {
  ...
  return (
    <div className="w-full space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-[#6E4294]">Edit Cartridge Category</h1>
        <p className="text-sm text-[#482072]">Update category details.</p>
      </div>
      ...
      >
        ...
        <div className="flex justify-end gap-3 pt-4">
          <button
            type="button"
            onClick={() => navigate("/admin/cartridge/categories")}
...
export default CartridgeCategoryEdit;
