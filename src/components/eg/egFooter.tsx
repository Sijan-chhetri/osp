...
const EgFooter: React.FC = () => {
  return (
    <footer className="w-full mt-[10px]" style={{ backgroundColor: "#EFDEE1" }}>
      {/* Main Footer Content */}
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">
                Premium Printer Cartridges for<br />Sharp, Reliable Printing
              </p>
            </div>
          </div>
          ...
          <div className="text-right">
            ...
            <div className="flex items-center justify-end gap-6">
              <a href="tel:+9779061565002" className="flex items-center gap-2 text-[#1e3a8a] hover:text-[#1e40af]">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
                </svg>
                +977 061565002
              </a>
              <a href="mailto:info@egcartridge.com" className="flex items-center gap-2 text-[#1e3a8a] hover:text-[#1e40af]">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
