      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-50">
        ...
        <section className="relative w-full min-h-screen flex flex-col items-center justify-center py-40 px-4">
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold text-[#482072] mb-4">Your Cart is Empty</h1>
            <p className="text-gray-600 mb-8 text-lg">
              Add some products to get started!
            </p>
            <button
              onClick={() => navigate("/")}
              className="bg-[#6E4294] text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-[#6A4BC4] transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Browse Products
            </button>
          </div>
        ...
        <div className="w-full max-w-6xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">
              {totalItemsInCart} {totalItemsInCart === 1 ? "item" : "items"} in your cart
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="bg-white rounded-xl shadow-md border border-gray-200 p-4 flex items-center gap-3">
                <input
                  type="checkbox"
                  id="select-all"
                  checked={selectedItems.length === totalItemsInCart && totalItemsInCart > 0}
              ...
              {isLoggedIn && apiCartItems.map((item, index) => (
                <div
                  key={index}
                  className={`bg-white rounded-2xl shadow-lg border-2 p-6 hover:shadow-xl transition-all ${
                    selectedItems.includes(index) ? "border-[#7B5DE8]" : "border-gray-100"
                  }`}
                >
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">{item.brand_name}</p>
                        </div>
                        <button
              ...
              {!isLoggedIn && cartItems.map((item, index) => (
                <div
                  key={index}
                  className={`bg-white rounded-2xl shadow-lg border-2 p-6 hover:shadow-xl transition-all ${
                    selectedItems.includes(index) ? "border-[#7B5DE8]" : "border-gray-100"
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          ...
                          <p className="text-gray-600 text-sm">{item.product.brand_name}</p>
                        </div>
                        <button
                          onClick={() => removeItem(index)}
                          className="text-red-500 hover:text-red-700 transition-colors p-2"
                      ...
                      <p className="text-gray-600 text-sm mb-4">{item.plan.features}</p>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {/* Price */}
                        <div className="text-right">
                          {item.plan.has_discount && item.plan.original_price && (
                            <p className="text-sm text-gray-400 line-through">
                              Rs. {parseFloat(item.plan.original_price) * item.quantity}
                            </p>
                          )}
                          <p className="text-2xl font-bold text-[#7B5DE8]">
                            Rs. {(parseFloat(item.plan.price) * item.quantity).toFixed(2)}
                          </p>
                        </div>
                      </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-gradient-to-br from-[#482072] to-[#7B5DE8] rounded-2xl shadow-xl p-8 text-white sticky top-32">
                ...
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="text-3xl font-bold">Rs. {calculateTotal().toFixed(2)}</span>
                </div>
